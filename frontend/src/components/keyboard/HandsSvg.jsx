...
const HandsSvg = ({ pressedKey }) => {
  return (
    <div style={{ width: '100%', height: 'auto', display: 'flex', justifyContent: 'center', gap: '20px' }}>
      {/* Left Hand */}
      <svg
        fill="#000000"
        height="223px"
