...
const DvorakKeyboardSvg = ({ pressedKey }) => {
  return (
    <div style={{ width: '100%', height:'auto' }}>
      ...
      >
        ...
        <text x="140" y="110" className="key-text">'</text>
        <text x="140" y="130" className="subtext">'</text>

        <rect id="keyW" x="180" y="80" width="60" height="60" className={`key ${pressedKey === 'keyW' ? 'key-pressed' : ''}`} />
        <text x="210" y="110" className="key-text">,</text>
        <text x="210" y="130" className="subtext">,</text>

        <rect id="keyE" x="250" y="80" width="60" height="60" className={`key ${pressedKey === 'keyE' ? 'key-pressed' : ''}`} />
        <text x="280" y="110" className="key-text">.</text>
        <text x="280" y="130" className="subtext">.</text>
        ...
        <text x="350" y="130" className="subtext">P</text>

        <rect id="keyT" x="390" y="80" width="60" height="60" className={`key ${pressedKey === 'keyT' ? 'key-pressed' : ''}`} />
        <text x="420" y="110" className="key-text">Y</text>
        <text x="420" y="130" className="subtext">Y</text>

        <rect id="keyY" x="460" y="80" width="60" height="60" className={`key ${pressedKey === 'keyY' ? 'key-pressed' : ''}`} />
        <text x="490" y="110" className="key-text">F</text>
        <text x="490" y="130" className="subtext">F</text>

        <rect id="keyU" x="530" y="80" width="60" height="60" className={`key ${pressedKey === 'keyU' ? 'key-pressed' : ''}`} />
        <text x="560" y="110" className="key-text">G</text>
        <text x="560" y="130" className="subtext">G</text>

        <rect id="keyI" x="600" y="80" width="60" height="60" className={`key ${pressedKey === 'keyI' ? 'key-pressed' : ''}`} />
        <text x="630" y="110" className="key-text">C</text>
        <text x="630" y="130" className="subtext">C</text>

        <rect id="keyO" x="670" y="80" width="60" height="60" className={`key ${pressedKey === 'keyO' ? 'key-pressed' : ''}`} />
        <text x="700" y="110" className="key-text">R</text>
        <text x="700" y="130" className="subtext">R</text>

        <rect id="keyP" x="740" y="80" width="60" height="60" className={`key ${pressedKey === 'keyP' ? 'key-pressed' : ''}`} />
        <text x="770" y="110" className="key-text">L</text>
        <text x="770" y="130" className="subtext">L</text>
        ...
        <text x="220" y="180" className="key-text">O</text>
        <text x="220" y="200" className="subtext">O</text>

        <rect id="keyD" x="260" y="150" width="60" height="60" className={`key ${pressedKey === 'keyD' ? 'key-pressed' : ''}`} />
        <text x="290" y="180" className="key-text">E</text>
        <text x="290" y="200" className="subtext">E</text>

        <rect id="keyF" x="330" y="150" width="60" height="60" className={`key ${pressedKey === 'keyF' ? 'key-pressed' : ''}`} />
        <text x="360" y="180" className="key-text">U</text>
        <text x="360" y="200" className="subtext">U</text>

        <rect id="keyG" x="400" y="150" width="60" height="60" className={`key ${pressedKey === 'keyG' ? 'key-pressed' : ''}`} />
        <text x="430" y="180" className="key-text">I</text>
        <text x="430" y="200" className="subtext">I</text>

        <rect id="keyH" x="470" y="150" width="60" height="60" className={`key ${pressedKey === 'keyH' ? 'key-pressed' : ''}`} />
        <text x="500" y="180" className="key-text">D</text>
        <text x="500" y="200" className="subtext">D</text>

        <rect id="keyJ" x="540" y="150" width="60" height="60" className={`key ${pressedKey === 'keyJ' ? 'key-pressed' : ''}`} />
        <text x="570" y="180" className="key-text">H</text>
        <text x="570" y="200" className="subtext">H</text>

        <rect id="keyK" x="610" y="150" width="60" height="60" className={`key ${pressedKey === 'keyK' ? 'key-pressed' : ''}`} />
        <text x="640" y="180" className="key-text">T</text>
        <text x="640" y="200" className="subtext">T</text>

        <rect id="keyL" x="680" y="150" width="60" height="60" className={`key ${pressedKey === 'keyL' ? 'key-pressed' : ''}`} />
        <text x="710" y="180" className="key-text">N</text>
        <text x="710" y="200" className="subtext">N</text>

        <rect id="keySemicolon" x="750" y="150" width="60" height="60" className={`key ${pressedKey === 'keySemicolon' ? 'key-pressed' : ''}`} />
        <text x="780" y="180" className="key-text">S</text>
        <text x="780" y="200" className="subtext">S</text>
        ...
        <text x="190" y="250" className="key-text">;</text>
        <text x="190" y="270" className="subtext">;</text>

        <rect id="keyX" x="230" y="220" width="60" height="60" className={`key ${pressedKey === 'keyX' ? 'key-pressed' : ''}`} />
        <text x="260" y="250" className="key-text">Q</text>
        <text x="260" y="270" className="subtext">Q</text>

        <rect id="keyC" x="300" y="220" width="60" height="60" className={`key ${pressedKey === 'keyC' ? 'key-pressed' : ''}`} />
        <text x="330" y="250" className="key-text">J</text>
        <text x="330" y="270" className="subtext">J</text>

        <rect id="keyV" x="370" y="220" width="60" height="60" className={`key ${pressedKey === 'keyV' ? 'key-pressed' : ''}`} />
        <text x="400" y="250" className="key-text">K</text>
        <text x="400" y="270" className="subtext">K</text>

        <rect id="keyB" x="440" y="220" width="60" height="60" className={`key ${pressedKey === 'keyB' ? 'key-pressed' : ''}`} />
        <text x="470" y="250" className="key-text">X</text>
        <text x="470" y="270" className="subtext">X</text>

        <rect id="keyN" x="510" y="220" width="60" height="60" className={`key ${pressedKey === 'keyN' ? 'key-pressed' : ''}`} />
        <text x="540" y="250" className="key-text">B</text>
        <text x="540" y="270" className="subtext">B</text>
        ...
        <text x="680" y="250" className="key-text">W</text>
        ...
        <text x="750" y="250" className="key-text">V</text>
        ...
        <text x="820" y="250" className="key-text">Z</text>
...
export default DvorakKeyboardSvg;
